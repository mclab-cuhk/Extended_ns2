...
\"\n\
checkout_executable TCLSH \"/home/mclab/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/mclab/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
Agent/TCP set windowInit_ 10 ;		# default changed on 2001/5/26.\n\
